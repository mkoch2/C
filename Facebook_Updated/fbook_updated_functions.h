...
#ifndef __FACEBOOK_UPDATED_FUNCTIONS_H__
#define __FACEBOOK_UPDATED_FUNCTIONS_H__
...
/*
   Function that prints an invalid message when the user is not found
*/
void print_user_not_found();

/*
   Function that prints the posts menu with a list of options for the user to choose from
*/
void manage_post_menu();

/*
   Function that returns the number of users in a linked list
*/
int length(user_t *user);

/*
   Function that prints the friends menu with a list of options for the user to choose from
*/
void manage_friends_menu(user_t *user);

/*
   Function that prints the login menu with a list of options for the user to choose from
*/
void login_menu();
